...
| [多地区任天堂官方搜索与自动监控设计规格](superpowers/specs/2026-07-18-multi-region-official-search-design.md) | 五区官方搜索、自动加入监控、候选选择与官方链接兜底 | 实施中；五区搜索与发现分流已实现，待人工确认校验与界面 |
| [多地区任天堂官方搜索与自动监控实施计划](superpowers/plans/2026-07-18-multi-region-official-search.md) | 五区搜索适配器、自动/人工确认边界、前端三态与受控生产验收 | 已批准，Task 3 待提交 |
