...
| [订阅硬删除与全局请求加载设计规格](superpowers/specs/2026-07-18-subscription-hard-delete-global-loading-design.md) | 仪表盘多选永久删除、详情删除返回及全局网络加载动画 | 部分实施：全局加载与 Worker 原子删除已完成，前端删除入口待实施 |
| [订阅硬删除与全局请求加载实施计划](superpowers/plans/2026-07-18-subscription-hard-delete-global-loading.md) | 请求计数器、批量原子删除、仪表盘/详情入口与最终质量验收 | 已批准，执行中 |
