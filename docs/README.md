...
| [NAS Docker 与 PostgreSQL 迁移实施计划](superpowers/plans/2026-07-27-nas-docker-postgresql-migration.md) | 平台中立重构、PostgreSQL、Node、调度器、本地 Playwright、容器、备份、发布和 NAS 切换的测试先行步骤 | 实施中；Task 1–6 已完成本地实现与验证，Task 5 使用原生 Node Fetch 适配器，Hono 依赖待环境允许后评估 |
