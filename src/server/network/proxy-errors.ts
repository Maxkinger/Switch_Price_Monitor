...
export function isProxyTransportError(error: unknown): error is ProxyTransportError {
  return error instanceof ProxyTransportError;
}

/** 将稳定的 Node 错误 code/name 映射为安全类别；原始 message 永不进入返回对象或日志。 */
