...
import { DashboardApiError, type SubscriptionDetail, type SubscriptionUpdate } from "./dashboard-api-client";
import { formatCnyFen, formatLocalPrice } from "./dashboard-view-model";

/** 详情页只依赖受控详情读取、刷新排队和现有 PATCH 写入接口，商品确认仍需回到添加订阅流程。 */
interface DetailApi {
